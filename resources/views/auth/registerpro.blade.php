    ...
    <div class="container px-4 px-md-5 text-center text-lg-start">
        <div class="col-lg-10 mb-lg-0 pb-5" style="z-index: 10">
            <h2 class="fw-bold ls-tight" style="color: hsl(218, 81%, 95%)">
                Je m'inscris en tant que <span style="color: hsl(218, 81%, 75%)">Professionnel</span>
            </h2>
        </div>
            ...
            <div class="card-body px-4 py-5 px-md-5">
              <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-outline mb-4">
                    <input type="hidden" id="form3Example3" class="form-control @error('role') is-invalid @enderror" name="role" value="professional"/>
                </div>
